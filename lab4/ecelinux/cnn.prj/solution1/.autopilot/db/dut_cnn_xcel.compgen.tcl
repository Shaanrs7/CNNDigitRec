...
set ID 46
set MemName dut_cnn_xcel_mem_conv1_0_V
...
# Memory (RAM/ROM)  definition:
set ID 47
set MemName dut_cnn_xcel_mem_conv1_1_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 200
...
# Memory (RAM/ROM)  definition:
set ID 48
set MemName dut_cnn_xcel_mem_conv2_V
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 800
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_V \
    op interface \
    ports { output_V_address0 { O 10 vector } output_V_ce0 { O 1 bit } output_V_we0 { O 1 bit } output_V_d0 { O 32 vector } } \
} "
} else {
