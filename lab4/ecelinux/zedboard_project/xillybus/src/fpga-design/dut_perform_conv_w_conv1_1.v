...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module dut_perform_conv_w_conv1_1_rom (
...
initial begin
    $readmemh("./dut_perform_conv_w_conv1_1_rom.dat", ram0);
    $readmemh("./dut_perform_conv_w_conv1_1_rom.dat", ram1);
    $readmemh("./dut_perform_conv_w_conv1_1_rom.dat", ram2);
end
...
`timescale 1 ns / 1 ps
module dut_perform_conv_w_conv1_1(
    reset,
    clk,
    address0,
    ce0,
...
dut_perform_conv_w_conv1_1_rom dut_perform_conv_w_conv1_1_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
